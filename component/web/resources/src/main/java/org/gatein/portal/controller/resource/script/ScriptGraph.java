...
public class ScriptGraph {
     ...
     */
    public ScriptResource addResource(ResourceId id, FetchMode fetchMode, String alias, String groupName, String contextPath, boolean amd)
        ...
        if (resource == null) {
            ...
            map.put(name, resource = new ScriptResource(this, id, fetchMode, alias, group, amd));
