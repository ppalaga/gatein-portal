...
public class ApplicationRegistryImpl implements ApplicationRegistry {
     ...
     */
    @Override
    public List<Application> getAllApplications() throws ApiException {
        try {
     ...
     * @return the application converted into a org.gatein.api.application.Application
     */
    private Application adaptApplication(org.exoplatform.application.registry.Application originalApplication) {
        ...
        application.setModifiedDate(originalApplication.getModifiedDate());
