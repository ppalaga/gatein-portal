...
public class PageBuilderImpl extends LayoutBuilderImpl<PageBuilder> implements PageBuilder {
    ...
    /**
     * @see LayoutBuilderImpl#beginLayoutContainer()
     */
    @Override
    public ContainerBuilder<PageBuilder> beginLayoutContainer() {
        return super.beginLayoutContainer();
    }
    ...
    public Page buildPage() {
        ...
        page.setContainer(getFinishedContainer());
